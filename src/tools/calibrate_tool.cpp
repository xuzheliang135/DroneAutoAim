...
static void StereoCalib(const vector <cv::Mat> &imagelist, Size boardSize, float squareSize,
                        string &filename_intrinsics_param, string &filename_extrinsics_param,
...
bool tool_for_calibrate(const cv::Mat &src_left, const cv::Mat &src_right) {
    ...
    if (imagelist.size() < image_max_num) {
        ...
        StereoCalib(imagelist, boardSize, squareSize, filename_intrinsics_param, filename_extrinsics_param, true, true,
                    true);
        imagelist.clear();
